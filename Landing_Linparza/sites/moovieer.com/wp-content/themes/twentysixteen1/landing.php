...
<section class="view">
    ...
    <div class="bg__view"></div>
		...
		<div class="container view__video-btn">
			...
			<div class="view__btn_flex">
				<div class="view__btn"><button class="make-photo">Сделать фото</button></div>
	...
	<section class="description">
		...
		<div class="description__about">
			<div class="description__text">– единственный PARP-ингибитор, одобренный
				...
				на ПЕРВУЮ ЛИНИЮ химиотерапии1.</div>
			<div class="description__text margin">– первый зарегистрированный в России ингибитор
				...
				в генах <i>BRCA</i> 1/21.</div>
			<div class="description__instruction">
				<div class="description__color">1.</div> Инструкция по медицинскому применению лекарственного
				...
				Доступно по <a href="" class="href__green">ссылке</a>. (дата обращения 07.06.2020).
			</div>
		</div>
	</section>
	...
	<section class="contacts">
		<div class="contacts__block">
			<h1 class="contacts__title">Контакты службы технической поддержки</h1>
